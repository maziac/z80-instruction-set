...
export const z80InstructionSetRawData = [
	...
	["IN A,(C)", "12", "14", "3", "ED 78", "2", "**0P0-", "A := port[BC]" ],
	["IN A,(n)", "11", "12", "3", "DB n", "2", "", "A := port[An]" ],
	["IN B,(C)", "12", "14", "4", "ED 40", "2", "**0P0-", "B := port[BC]" ],
	["IN C,(C)", "12", "14", "4", "ED 48", "2", "**0P0-", "C := port[BC]" ],
	["IN D,(C)", "12", "14", "4", "ED 50", "2", "**0P0-", "D := port[BC]" ],
	["IN E,(C)", "12", "14", "4", "ED 58", "2", "**0P0-", "E := port[BC]" ],
	["IN F,(C)", "12", "14", "4", "ED 70", "3", "******", "F := port[BC]" ], // alt. IN (C)
	["IN H,(C)", "12", "14", "4", "ED 60", "2", "**0P0-", "H := port[BC]" ],
	["IN L,(C)", "12", "14", "4", "ED 68", "2", "**0P0-", "L := port[BC]" ],
	...
	["IND", "16", "18", "5", "ED AA", "2", "******", "[HL] := port[BC], HL := HL-1, B := B-1, Z is set if BC == 0"],
	["INDR", "21/16", "23/18", "6/5", "ED BA", "2", "******", "IND until B == 0" ],
	["INI", "16", "18", "5", "ED A2", "2", "******", "[HL] := port[BC], HL := HL+1, B := B-1, Z is set if BC == 0"],
	["INIR", "21/16", "23/18", "6/5", "ED B2", "2", "******", "INI until B == 0" ],
	...
	["LD A,I", "9", "11", "3", "ED 57", "2", "**0?0-", "A := I, P := IFF2"],
	...
	[ "LD A,R", "9", "11", "3", "ED 5F", "2", "**0?0-", "A := R, P := IFF2"],
	...
	["OTDR", "21/16", "23/18", "6/5", "ED BB", "2", "******", "OUTD until B == 0" ],
	["OTIR", "21/16", "23/18", "6/5", "ED B3", "2", "******", "OUTI until B == 0"  ],
	...
	["OUTD", "16", "18", "5", "ED AB", "2", "******", "B := B-1, port[BC] := [HL], HL := HL-1" ],
	["OUTI", "16", "18", "5", "ED A3", "2", "******", "B := B-1; port[BC] := [HL], HL := HL+1"],
