...
export const z80InstructionSetRawData = [
	["ADC A,(HL)", "7", "8", "2", "8E", "1", "***V0*", "A += [HL]+CY" ],
	["ADC A,(IX+o)", "19", "21", "3", "DD 8E o", "3", "***V0*", "A += [IX+o]+CY"],
	["ADC A,(IY+o)", "19", "21", "3", "FD 8E o", "3", "***V0*", "A += [IY+o]+CY"],
	["ADC A,IXp", "8", "10", "2", "DD 88+p", "2"],
	[ "ADC A,IYq", "8", "10", "2", "FD 88+q", "2" ],
	["ADC A,n", "7", "8", "2", "CE n", "2", "***V0*", "A += n+CY" ],
	["ADC A,r", "4", "5", "1", "88+r", "1", "***V0*", "A += r+CY"],
	["ADC HL,BC", "15", "17", "4", "ED 4A", "2", "***V0*", "HL += BC+CY" ],
	["ADC HL,DE", "15", "17", "4", "ED 5A", "2", "***V0*", "HL += DE+CY" ],
	["ADC HL,HL", "15", "17", "4", "ED 6A", "2", "***V0*", "HL += HL+CY" ],
	["ADC HL,SP", "15", "17", "4", "ED 7A", "2", "***V0*", "HL += SP+CY" ],
	["ADD A,(HL)", "7", "8", "2", "86", "1", "***V0*", "A+=[HL]" ],
	["ADD A,(IX+o)", "19", "21", "3", "DD 86 o", "3", "***V0*", "A += [IX+o]" ],
	["ADD A,(IY+o)", "19", "21", "3", "FD 86 o", "3", "***V0*", "A += [IY+o]" ],
	[ "ADD A,IXp", "8", "10", "2", "DD 80+p", "2" ],
	[ "ADD A,IYq", "8", "10", "2", "FD 80+q", "2" ],
	["ADD A,n", "7", "8", "2", "C6 n", "2", "***V0*", "A += n" ],
	["ADD A,r", "4", "5", "1", "80+r", "1", "***V0*", "A += r" ],
	["ADD HL,BC", "11", "12", "3", "9", "1", "--*-0*", "HL += BC" ],
	["ADD HL,DE", "11", "12", "3", "19", "1", "--*-0*", "HL += DE" ],
	["ADD HL,HL", "11", "12", "3", "29", "1", "--*-0*", "HL += HL" ],
	["ADD HL,SP", "11", "12", "3", "39", "1", "--*-0*", "HL += SP" ],
	["ADD IX,BC", "15", "17", "4", "DD 09", "2", "--*-0*", "IX += BC" ],
	["ADD IX,DE", "15", "17", "4", "DD 19", "2", "--*-0*", "IX += DE" ],
	["ADD IX,IX", "15", "17", "4", "DD 29", "2", "--*-0*", "IX += IX" ],
	["ADD IX,SP", "15", "17", "4", "DD 39", "2", "--*-0*", "IX += SP" ],
	["ADD IY,BC", "15", "17", "4", "FD 09", "2", "--*-0*", "IY += BC" ],
	["ADD IY,DE", "15", "17", "4", "FD 19", "2", "--*-0*", "IY += DE" ],
	["ADD IY,IY", "15", "17", "4", "FD 29", "2", "--*-0*", "IY += IY" ],
	["ADD IY,SP", "15", "17", "4", "FD 39", "2", "--*-0*", "IY += SP" ],
	...
	["CPD", "16", "18", "4", "ED A9", "2", "****1-", "A-[HL], HL--, BC--, P/V=0 if BC == 0" ],
	["CPDR", "21/16", "23/18", "6/4", "ED B9", "2", "****1-", "CPD until A == [HL] or BC == 0" ],
	["CPI", "16", "18", "4", "ED A1", "2", "****1-", "A-[HL], HL++, BC--, P/V=0 if BC == 0" ],
	...
	["DEC (HL)", "11", "12", "3", "35", "1", "***V1-", "[HL]--" ],
	["DEC (IX+o)", "23", "25", "6", "DD 35 o", "3", "***V1-", "[IX+o]--"  ],
	["DEC (IY+o)", "23", "25", "6", "FD 35 o", "3", "***V1-", "[IY+o]--"  ],
	["DEC A", "4", "5", "1", "3D", "1", "***V1-", "A--"  ],
	["DEC B", "4", "5", "1", "5", "1", "***V1-", "B--"  ],
	[ "DEC BC", "6", "7", "2", "0B", "1", "", "BC--" ],
	["DEC C", "4", "5", "1", "0D", "1", "***V1-", "C := C-1" ],
	["DEC D", "4", "5", "1", "15", "1", "***V1-", "D--" ],
	["DEC DE", "6", "7", "2", "1B", "1", "", "DE--" ],
	["DEC E", "4", "5", "1", "1D", "1", "***V1-", "E--" ],
	["DEC H", "4", "5", "1", "25", "1", "***V1-", "H--" ],
	["DEC HL", "6", "7", "2", "2B", "1", "", "HL--" ],
	["DEC IX", "10", "12", "3", "DD 2B", "2", "", "IX--" ],
	[ "DEC IXp", "8", "10", "2", "DD 05+8*p", "2" ],
	["DEC IY", "10", "12", "3", "FD 2B", "2", "", "IY--" ],
	[ "DEC IYq", "8", "10", "2", "FD 05+8*q", "2" ],
	["DEC L", "4", "5", "1", "2D", "2", "***V1-", "L--" ],
	["DEC SP", "6", "7", "2", "3B", "1", "", "SP--" ],
	[ "DI", "4", "5", "1", "F3", "1", "", "disable interrupts" ],
	["DJNZ o", "13/8", "14/9", "4/3", "10 o", "2", "", "B--, if B != 0 then jump" ],
