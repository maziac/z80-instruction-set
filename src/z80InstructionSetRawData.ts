...
export const z80InstructionSetRawData = [
	...
	["SRA (HL)", "15", "17", "4", "CB 2E", "2", "**0P0*", "Shift [HL] arithmetical right, 7>7>6>5>4>3>2>1>0>CY', i.e. [HL] := [HL]/2 (signed), bit 7 keeps it's value"],
	["SRA (IX+o)", "23", "25", "7", "DD CB o 2E", "4", "**0P0*", "Shift [HL] arithmetical right, 7>7>6>5>4>3>2>1>0>CY', i.e. [HL] := [HL]/2 (signed), bit 7 keeps it's value" ],
	["SRA (IY+o)", "23", "25", "7", "FD CB o 2E", "4", "**0P0*", "Shift [HL] arithmetical right, 7>7>6>5>4>3>2>1>0>CY', i.e. [HL] := [HL]/2 (signed), bit 7 keeps it's value" ],
	["SRA r", "8", "10", "2", "CB 28+r", "2", "**0P0*", "Shift [HL] arithmetical right, 7>7>6>5>4>3>2>1>0>CY', i.e. [HL] := [HL]/2 (signed), bit 7 keeps it's value" ],
